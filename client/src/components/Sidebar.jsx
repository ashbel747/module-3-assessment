...
const Sidebar = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 h-full w-64 bg-blue-600 text-white z-50 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 flex flex-col`}>
      {/* Sidebar header */}
